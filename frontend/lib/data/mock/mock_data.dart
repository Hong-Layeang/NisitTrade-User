...
final List<CommunityPost> mockCommunityPosts = [
  CommunityPost(
    id: 'cp1',
    author: mockSellers[0],
    content:
        'A moment full of energy and smiles as students enjoy Sports Day on campus. Fun activities, teamwork, and healthy vibes all around.',
    imageUrl:
  ...
  CommunityPost(
    id: 'cp2',
    author: mockSellers[2],
    content:
        'Walking through campus with friends! 🌳✨ Enjoying the sunshine, chats, and spontaneous laughter along the way.',
    imageUrl:
  ...
  CommunityPost(
    id: 'cp3',
    author: mockSellers[4],
    content:
        'Study group goals. Midterms prep with the squad. Coffee, notes, and good motivation.',
    imageUrl:
